...
// nodemon'u her yenilendiğinde tekrar render etsin diye koyduk
// heroku üzerinde hostlayacağız
...
// https://dashboard.scraperapi.com/dashboard buradan aldık
...
// expres json kullanabilsin diye ekledik
...
app.get('/products/:productId', async (req, res) => {
    ...
    try {
        const response = await request(`${generateScraperUrlgenerateScraperUrl(api_key)}&url=https://www.amazon.com/dp/${productId}`)
